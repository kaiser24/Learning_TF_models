...
def main():
  source_file_list = "/home/pdi/Felipe_data/YoloToTfRecords/test.txt"  # CHANGE PATH TO YOUR FILE - LIST of jpg files with xml file next to them in the same directory
  dest_csv_file = '/home/pdi/Felipe_data/YoloToTfRecords/test.csv'  # CHANGE PATH TO YOUR FILE
